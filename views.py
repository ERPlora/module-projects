...
@login_required
@htmx_view('projects/pages/project_add.html', 'projects/partials/project_add_content.html')
def project_add(request):
    ...
    if request.method == 'POST':
        ...
        response['HX-Redirect'] = reverse('projects:projects_list')
        return response
    return {}

@login_required
@htmx_view('projects/pages/project_edit.html', 'projects/partials/project_edit_content.html')
